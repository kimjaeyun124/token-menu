...
Codex app-server 데몬을 사용할 수 있으면 사용량 창에 현재 활성 작업, 대기 상태와 경과 시간을 표시합니다. 읽기 전용 연결이므로 Codex 작업에 프롬프트를 보내거나 작업을 변경하지 않습니다.

데스크톱 Codex가 별도 stdio 서버를 사용할 때는 로컬 작업 생명주기 기록도 확인해 진행 중인 작업을 감지합니다. 프롬프트와 도구 내용은 읽지 않습니다.
